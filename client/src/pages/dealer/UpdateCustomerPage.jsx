...
const UpdateCustomerPage = () => {
    ...
    const { data } = useGetUserByIdQuery(customerId);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // Update Dealer
            const updated = await updateUser({ updateData: formData, id: customerId});
        ...
        <div className="flex bg-gray-50 text-gray-900 w-full min-h-screen">
            ...
            >
                <Navbar>
                    <nav className="w-full rounded-md">
                        <ol className="list-reset flex">
                            ...
                            <li className="text-neutral-400">Update Customer</li>
                        </ol>
                    </nav>
                </Navbar>
                ...
                <div className="flex gap-3 items-center pl-1">
                    ...
                    <h2 className="font-semibold text-lg">Update Customer</h2>
                </div>
